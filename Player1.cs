...
public class Player1 : MonoBehaviour
{
    ...
    void Attack() {
        if (跳控制器 == true && 控制器.GetBool("跑步") == false && 控制器.GetBool("後走") == false
            ...
            if (Input.GetKeyDown(KeyCode.J) && SiroYukiSkillJ.isStartTime == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招2") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("中招2") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大招") == false)
            {
                SiroYukiSkillJ.isStartTime = true;
            ...
            else if (Input.GetKeyDown(KeyCode.K) && SiroYukiSkillK.isStartTime == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招1") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("中招2") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大招") == false)
            {
                SiroYukiSkillK.isStartTime = true;
            ...
            else if (Input.GetKeyDown(KeyCode.U) && SiroYukiSkillU.isStartTime == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招1") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招2") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大招") == false)
            {
                SiroYukiSkillU.isStartTime = true;
            ...
            else if (Input.GetKeyDown(KeyCode.I) && SiroYukiSkillI.isStartTime == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招1") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("小招2") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("中招2") == false)
            {
                SiroYukiSkillI.isStartTime = true;
                移動控制 = false;
                控制器.SetBool("大招", true);
