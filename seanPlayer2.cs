...
public class seanPlayer2 : MonoBehaviour
{
    ...
    void Attack()
    {
        ...
        {
            if (Input.GetKeyDown(KeyCode.Keypad1) && 控制器.GetCurrentAnimatorStateInfo(0).IsName("右出拳") == false
                ...
                && seanSkill1.isStartTime == false)
            {
                seanSkill1.isStartTime = true;
            ...
            else if (Input.GetKeyDown(KeyCode.Keypad2) && 控制器.GetCurrentAnimatorStateInfo(0).IsName("膝擊") == false 
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("右出拳") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("踢擊") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("連打") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大絕") == false
                && seanSkill2.isStartTime == false)
            {
                seanSkill2.isStartTime = true;
                控制器.SetBool("膝擊", true);
            ...
            else if (Input.GetKeyDown(KeyCode.Keypad4) && 控制器.GetCurrentAnimatorStateInfo(0).IsName("連打") == false 
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("右出拳") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("膝擊") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("踢擊") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大絕") == false
                && seanSkill4.isStartTime == false)
            {
                seanSkill4.isStartTime = true;
                控制器.SetBool("連打", true);
            ...
            else if (Input.GetKeyDown(KeyCode.Keypad5) && 控制器.GetCurrentAnimatorStateInfo(0).IsName("大絕") == false 
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("右出拳") == false && 控制器.GetCurrentAnimatorStateInfo(0).IsName("膝擊") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("踢擊") == false
                && 控制器.GetCurrentAnimatorStateInfo(0).IsName("連打") == false 
                && seanSkill5.isStartTime == false)
            {
                seanSkill5.isStartTime = true;
                //移動控制 = false;
                控制器.SetBool("大絕", true);
