...
public class SiroYukiSkillL : MonoBehaviour
{
    ...
    {
        //Debug.Log(isStart);
        if (Input.GetKeyDown(KeyCode.L))//當按下鍵盤上的L键，技能
            isStart = true;
        if (isStart)//當開始計時時執行下列代碼
        {
